...
class CustomCustomCAPlugin : public QObject, public SkydelCoreInterface, public SkydelCustomSignalFactoryInterface
{
  Q_OBJECT
...
REGISTER_SKYDEL_PLUGIN(CustomCustomCAPlugin)
